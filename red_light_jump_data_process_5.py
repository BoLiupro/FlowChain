...
if __name__ == "__main__":
    ...
    parser.add_argument('--center_frame', type=int, default=621, help='Center frame for processing')
    ...
    # out_dir = "/root/workspace/FlowChain-ICCV2023/src/data/TP/raw_data/eth"
